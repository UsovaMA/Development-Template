...
Contact::Contact(string name, string fam, string pat) {
  lname = name;
  fname = fam;
  patro = pat;
  phone = "0";
...
Contact::Contact(string name, string fam, string pat, string ph, bool like) {
  lname = name;
  fname = fam;
  patro = pat;
  phone = ph;
...
ostream& operator << (ostream& stream, const Contact& a) {
  cout <<"            name: " << a.fname  <<" " << a.lname << " " << a.patro << endl;
  if ((a.phone != "0")&&(a.phone != "")) cout <<"           phone:" << " " << a.phone << endl;
  string B = a.DatBir;
...
bool Contact::operator>(const Contact & t) {
  int a = high_name(fname, t.fname);
  if (a == 1) return true;
  if (a == 0) return false;
  a = high_name(lname, t.lname);
  if (a == 1) return true;
  if (a == 0) return false;
  a = high_name(patro, t.patro);
  if (a == 1) return true;
  if (a == 0) return false;
  return true;
}
